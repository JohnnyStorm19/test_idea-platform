...
//     case "SU":
//       return import(
//         `/src/shared/assets/images/carriers/Aeroflot_Soviet_Airlines_logo.png`
//       );
//     case "TK":
//       return import(`/src/shared/assets/images/carriers/turkish-airlines-logo.png`);
//     case "S7":
//       return import(`/src/shared/assets/images/carriers/S7_new_logo.png`);
//     case "carrier4":
//       return import(`/src/shared/assets/images/carriers/british-airways-logo.png`);
//     default:
//       return import(`./images/default.png`); // Use a default image if carrier is not recognized
//   }
// };
export const getImagePath = (carrier: string) => {
    switch (carrier) {
